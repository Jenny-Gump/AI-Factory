...
- **Специализация**: Информационные статьи (`basic_articles`) - 12-этапный пайплайн с FAQ и источниками + fact-checking
- **Multi-LLM система**: 100% бесплатный DeepSeek по умолчанию + Perplexity Sonar (fact-check) + автоматические ретраи + фоллбек на Gemini 2.5
