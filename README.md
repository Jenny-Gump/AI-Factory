...
Автоматизированный 14-этапный пайплайн для генерации высококачественного контента с публикацией в WordPress.

## ✨ Основные возможности

- **100% бесплатные LLM**: DeepSeek Chat v3.1 FREE + Google Gemini 2.5 Flash (fact-check с веб-поиском)
- **14-этапный пайплайн**: Поиск → Парсинг → Генерация → Fact-check → Link placement → Translation → Публикация
...
**Последние изменения**:
- ✅ Translation stage (этап 12) - многоязычная поддержка
- ✅ Link placement (этап 11) - автоматическое добавление 10-20 ссылок
- ✅ Gemini fact-check (этап 10) - проверка фактов с веб-поиском
- ✅ Enhanced spam detection - валидация качества контента
