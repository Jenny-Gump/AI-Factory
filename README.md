...
- **Специализация**: Информационные статьи (`basic_articles`) - 10-этапный пайплайн с FAQ и источниками + fact-checking
...
10. **Редакторский обзор** - Финальная обработка для WordPress
