...
- **12-этапный пайплайн**: 1-6: Сбор данных → 7-8: Структурирование → 08: Генерация → 09: Translation → 10: Fact-check → 11: Link placement → 12: Editorial review → WordPress (опционально)
